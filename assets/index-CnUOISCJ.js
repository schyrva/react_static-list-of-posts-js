...
aut aut aut maxime quia temporibus ut omnis`}],Nc=[{id:1,name:"Leanne Graham",username:"Bret",email:"Sincere@april.biz"},{id:2,name:"Ervin Howell",username:"Antonette",email:"Shanna@melissa.tv"},{id:3,name:"Clementine Bauch",username:"Samantha",email:"Nathan@yesenia.net"},{id:4,name:"Patricia Lebsack",username:"Karianne",email:"Julianne.OConner@kory.org"},{id:5,name:"Chelsey Dietrich",username:"Kamren",email:"Lucio_Hettinger@annie.ca"},{id:6,name:"Mrs. Dennis Schulist",username:"Leopoldo_Corkery",email:"Karley_Dach@jasper.info"},{id:7,name:"Kurtis Weissnat",username:"Elwyn.Skiles",email:"Telly.Hoeger@billy.biz"},{id:8,name:"Nicholas Runolfsdottir V",username:"Maxime_Nienow",email:"Sherwood@rosamond.me"},{id:9,name:"Glenna Reichert",username:"Delphine",email:"Chaim_McDermott@dana.io"},{id:10,name:"Clementina DuBuque",username:"Moriah.Stanton",email:"Rey.Padberg@karina.biz"}],Pc=({comment:e})=>{const{name:t,email:i,body:n}=e||{};return $.jsxs("div",{className:"CommentInfo",children:[$.jsx("h3",{className:"CommentInfo__name",children:t}),$.jsx("a",{className:"CommentInfo__email",href:`mailto:${i}`,children:i}),$.jsx("p",{className:"CommentInfo__body",children:n})]})},Lc=({comments:e})=>e.length===0?null:$.jsx("div",{className:"CommentList",children:e.map(t=>$.jsx(Pc,{comment:t},t.id))}),Tc=({user:e})=>{if(!e)return $.jsx("div",{className:"UserInfo",children:"User information is not available"});const{name:t,email:i}=e;return $.jsx("a",{className:"UserInfo",href:`mailto:${i}`,children:t})},Mc=({post:e})=>{if(!e)return $.jsx("div",{children:"Post data is missing"});const{title:t,body:i,user:n,comments:a}=e;return $.jsxs("div",{className:"PostInfo",children:[$.jsx("h2",{className:"PostInfo__title",children:t}),$.jsx("p",{className:"PostInfo__body",children:i}),$.jsx(Tc,{user:n}),a&&a.length>0?$.jsx(Lc,{comments:a}):$.jsx("div",{"data-cy":"NoCommentsMessage",children:"No comments available"})]})},Rc=({posts:e})=>$.jsx("div",{className:"PostList",children:e.map(t=>$.jsx(Mc,{post:t},t.id))}),Dc=Cc.map(e=>{const t=Nc.find(n=>n.id===e.userId),i=zc.filter(n=>n.postId===e.id);return{...e,user:t,comments:i}}),jc=()=>$.jsxs("section",{className:"App",children:[$.jsx("h1",{className:"App__title",children:"Static list of posts"}),$.jsx(Rc,{posts:Dc})]});em(document.getElementById("root")).render($.jsx(jc,{}));
